...
const Instructions = () => {
  return (
    <div className="recipe__block-left__instructions">
      <h2 className="recipe__block-left__instructions__title">
        Instructions
      </h2>
      <div className="recipe__block__instructions__steps">
        <div className="recipe__block__instructions__step">
