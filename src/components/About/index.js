...
import picture from 'src/assets/images/meme.png';
import './styles.scss';
        ...
        <div className="container__section--flex">
          {members.map((member) => (
            <article key={member.id} className="section__card">
              <img src={picture} alt="plant-icon" className="section__card__image" />
